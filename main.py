...
async def admin_panel_page(request):
    ...
    parts = [
        ...
        '<title>KITA Admin</title><link rel="icon" type="image/svg+xml" href="/static/KITA_LOGO.svg">',
        '<style>',
        ...
        'h1{font-size:20px;font-weight:800;color:#58a6ff;margin-bottom:4px}',
        ...
        '</style></head><body>',
        '<div class="box">',
        '<div class="logo"><img src="/static/KITA_LOGO.svg" style="width:180px;height:auto" alt="KITA"></div>',
        '<h1>HANCOM Academy</h1>',
        '<p class="sub">Admin paneliga kirish uchun parol kiriting</p>',
